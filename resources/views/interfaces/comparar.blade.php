...
<h2>MENU SONGS</h2>
    <h1>Trending songs just a click away!</h1><br><br>
            ...
            <table>
                <thead>
                    ...
                    @foreach ($hashNames as $hashName)
                        ...
                        <tr>
                        <td>
                            <button class="audio-control" data-src="../storage/app/public/{{ $audio->hashName }}">
                        <img src="assets\play.png"  />
                            ...
                            <td>
                                <form action="{{route('addfavorite',$audio->id)}}" method="post"> @csrf @method('POST')
                                    <button type="submit" class="btnlike" ><img src="assets\like.png"></button>
                                    
                                </form>
                            </td>
                            <td>
                                <form action="{{route('addsong', ['songid'=> $audio->id])}}" method="post">
                                    @csrf
                                    <input type="hidden" name="hashName" value="{{ $audio->hashName }}">
                                    <button type="submit" class="btnplus"><img src="assets\plus.png" alt="Agregar"></button>
                                </form>
                            </td>
                        </tr>
